...
export class CandidacyService {
  ...
  private baseUrl = 'http://localhost:8083/api/candidacy';

  private BASE_URL = 'http://localhost:8083/api/candidacy/getCandidacy1';
  private BASE_URL2 = 'http://localhost:8083/api/candidacy/create';
  private BASE_URL1 = 'http://localhost:8083/api/candidacy/candidature';
  private BASE_URL3= "http://localhost:8083/api/candidacy/delete"; 
  private BASE_URL4="http://localhost:8083/api/candidacy/update2";
  private BASE_URL5='http://localhost:8083/api/candidacy/modifier';
  private BASE_URL6="http://localhost:8083/api/candidacy/update1"; 
  private BASE_URL7="http://localhost:8083/api/candidacy/put"; 
  private BASE_URL8='http://localhost:8083/api/candidacy/update/status';
  private apiUrl = 'http://localhost:8083/api/candidacy/pdf';
