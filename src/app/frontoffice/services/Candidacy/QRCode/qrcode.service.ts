...
export class QrcodeService {
  private baseUrl = ' http://localhost:8083/api/candidacy/ajouterQR'; // Change this to match your API endpoint
  private baseUrl1 = 'http://localhost:8083/api/candidacy/afficher';
