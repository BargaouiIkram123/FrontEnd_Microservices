...
export class ResultService {
  ...
  private baseUrl = 'http://localhost:8083/api/result';

  private BASE_URL = 'http://localhost:8083/api/result/getResult';
  private BASE_URL2 = 'http://localhost:8083/api/result';
  private BASE_URL3= "http://localhost:8083/api/result/delete"; 
  private BASE_URL4="http://localhost:8083/api/candidacy/update";
  private BASE_URL5='http://localhost:8083/api/candidacy/candidacyId';
  private BASE_URL6="http://localhost:8083/api/result"; 
  private BASE_URL7="http://localhost:8083/api/candidacy/addResult"; 
  private BASE_URL8='http://localhost:8083/api/result/employees';
