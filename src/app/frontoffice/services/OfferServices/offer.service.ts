...
export class OfferService {
  ...
  private BASE_URL = 'http://localhost:8082/api/offers/getOffers';
  private BASE_URL2 ='http://localhost:8082/api/offers/createOffer';
  private BASE_URL3= "http://localhost:8060/InterMove/Events/delete"; 
  private BASE_URL4=" http://localhost:8082/api/offers/employees";
  private BASE_URL5="http://localhost:8082/api/offers";
  private BASE_URL6="http://localhost:8060/InterMove/Events"; 
  private BASE_URL7="http://localhost:8060/InterMove/Events/addEvent"; 
  private BASE_URL8 = 'http://localhost:8082/api/offers/delete';
  private BASE_URL9="http://localhost:8082/api/offers/export/excel";
  private apiUrl = 'http://localhost:8082/api/offers/pdf';
